...
const data = sectionData.project;
...
{/* <!--====================== project ======================--> */}
<section
  className="project pb-90 mb-120"
  ...
  <div className="container">
    ...
    >
      <div className="project-item">
        <div className="grid" >
          {/* <!--======================== single project  ========================--> */}
          <Masonary className="portfolio-filter row" imagesLoadedOptions={imagesLoadedOptions}>
          {
            this.state.filterProject.map((item, i) => ( 
                <div className={`col-md-6 col-lg-4 grid-item filter-item`} key={i}>
